# corporate/reports/excel_report/sheets/sheet_abc_manufacturers.py
...
def build_abc_manufacturers_sheet(wb, rows):
    ws = wb.create_sheet("ABC manufacturers")

    draw_toc_button(ws, cell="A1", target_sheet="TOC")
    draw_sheet_header(
        ws,
        title="ABC по производителям",
        subtitle="ABC-анализ производителей по выручке",
