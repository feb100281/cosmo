...
#         subtitle="Сравнение ширины ассортимента и выручки на 1 SKU",
#         note=(
#             "Лист показывает, компенсируется ли изменение количества SKU "
#             "ростом или снижением выручки на 1 SKU."
#         ),
#         line_to_col=12,
#     )
...
#             "sku_count": _safe_float(r.get("sku_count")),
#             "revenue": _safe_float(r.get("revenue_ytd")),
#         }
...
#         sku_prev = _safe_float(prev_vals.get("sku_count"))
#         sku_last = _safe_float(last_vals.get("sku_count"))
...
#                 "rev_last": rev_last,
#                 "delta_rev": delta_rev,
#                 "rev_per_sku_prev": rev_per_sku_prev,
#                 "rev_per_sku_last": rev_per_sku_last,
#                 "delta_rev_per_sku": delta_rev_per_sku,
#                 "status": status,
#             }
#         )
...
#                 r["category"],
#                 r["subcategory"],
#                 None if r["sku_prev"] == 0 else r["sku_prev"],
#                 None if r["sku_last"] == 0 else r["sku_last"],
#                 None if r["delta_sku"] == 0 else r["delta_sku"],
#                 None if r["rev_prev"] == 0 else r["rev_prev"],
#                 None if r["rev_last"] == 0 else r["rev_last"],
#                 None if r["delta_rev"] == 0 else r["delta_rev"],
#                 None if r["rev_per_sku_prev"] == 0 else r["rev_per_sku_prev"],
#                 None if r["rev_per_sku_last"] == 0 else r["rev_per_sku_last"],
#                 None if r["delta_rev_per_sku"] == 0 else r["delta_rev_per_sku"],
#                 r["status"],
#             ],
#             number_formats={
#                 3: "#,##0",
...
#         if isinstance(ws.cell(cur_row, 5).value, (int, float)) and ws.cell(cur_row, 5).value < 0:
#             ws.cell(cur_row, 5).fill = FILLS["section"]
#             ws.cell(cur_row, 5).font = FONTS["bold"]

#         if isinstance(ws.cell(cur_row, 11).value, (int, float)) and ws.cell(cur_row, 11).value < 0:
#             ws.cell(cur_row, 11).fill = FILLS["section"]
#             ws.cell(cur_row, 11).font = FONTS["bold"]

#         total_prev_sku += r["sku_prev"]
#         total_last_sku += r["sku_last"]
#         total_prev_rev += r["rev_prev"]
#         total_last_rev += r["rev_last"]
#         rev_per_sku_deltas.append(r["delta_rev_per_sku"])
