...
def build_index_sheet(wb, generated_at=None):
    ...
    links = [
        ...
        ("15", "Ассортимент vs выручка", "Сопоставление ассортимента и результата", "key"),
        ("16", "ABC по производителям", "ABC-анализ производителей", "key"),
        ("17", "ABC по категориям", "ABC-анализ категорий", "key"),
        # ("15", "Новые vs старые производители", "Сравнение новых и действующих производителей", "key"),
        ("18", "Магазин × производитель", "Матрица каналов/магазинов и производителей", "key"),
        ("19", "Топ товаров", "Лидеры продаж по товарам", "key"),
